...
class AutoRecoveryEngine:
    ...
    def __init__(self, state, supabase, logger, execute_recovery_func: Callable = None):
        self.state = state
        self.supabase = supabase
        self.logger = logger
        
        # Bug Fix 3: 순환 import 방지 - execute_recovery를 콜백으로 주입
        self.execute_recovery_func = execute_recovery_func
